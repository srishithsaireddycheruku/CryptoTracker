...
function CoinTable(){
    ...
    const { data, isLoading, isError, error } = useQuery({
        queryKey: ['coins', page,currency], // to uniquely identify the query and to cache the data based on the page and currency
    ...
    return(
        <>
            <div className="my-5 flex flex-col items-center justify-center gap-5 w-[80vw] mx-auto">
                {/*header of the table */}
                {currency.toUpperCase()} Price Table
                ...
                <div className="flex flex-col w-[80vw] mx-auto">
                    ...
                    {data && data.map((coin)=>{
                        return(
                          ...
                          key={coin.id}
                          className="w-full bg-transparent text-white flex py-4 px-2 font-semibold items-center justify-betweem cursor-pointer">
